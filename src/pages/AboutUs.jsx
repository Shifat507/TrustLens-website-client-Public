    ...
    <div className="bg-base-100 py-12 px-6 md:px-12">
      ...
      <div className="max-w-7xl mx-auto text-center mt-16 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card shadow-lg border rounded-lg p-6 bg-green-200 hover:shadow-xl">
          ...
          <div className="card shadow-lg border rounded-lg p-6 bg-green-300 hover:shadow-xl">
            <div className="flex justify-center items-center text-primary mb-4">
              <FaUsers size={40} />
            </div>
